...
(function (root) {
  ...
  const SYN = {
    ...
    full_name:  ['שם מלא', 'שם משפחה ושם פרטי', 'שם פרטי ומשפחה', 'שם ושם משפחה', 'שם פרטי ושם משפחה', 'שם משפחה ופרטי', 'שם מלא של הסטודנט', 'שם הזכאי', 'שם הבוגר', 'שם המסיים', 'שם המבקש', 'שם המבוטח', 'שם העובד', 'שם הלקוח', 'שם התלמיד', 'שם המשתתף', 'שם משתתף', 'שם המועמד', 'שם הנרשם', 'שם הסטודנט', 'שם ההורה', 'שם וחתימה', 'full name', 'name', 'שם', 'الاسم الكامل', 'الاسم الرباعي'],
    id:         ['תעודת זהות', 'מספר תעודת זהות', 'מס ת ז', 'מספר ת ז', 'ת ז סטודנט', 'תעודת זהות סטודנט', 'מספר זהות', 'מס תעודת זהות', 'ת ז', 'תז', 'ת.ז', 'מס זהות', 'מספר ת ז', 'זהות', 'מספר זיהוי', 'id number', 'national id', 'id', 'رقم الهوية', 'الهوية', 'رقم هوية', 'بطاقة الهوية'],
