...
async function main() {
  ...
  check('single-file: quick-setup + page controls present', await page.evaluate(() => ['quickSetupBtn', 'rotateBtn', 'attachBtn', 'deleteBtn'].every((id) => !!document.getElementById(id))));
